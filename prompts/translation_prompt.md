...
- Example for tables: Cells containing words like "Equipment", "Identification", "Effective Date", "Revision", or descriptive product type names like "ELEVATING DE-DUSTER" MUST be translated (e.g., to "Equipo", "Identificación", "Fecha de Vigencia", "Revisión", "DESEMPOLVADOR ELEVADOR").
...
- Do NOT explain the translation, do NOT write "Here is the translation:", and do NOT add any introductory or concluding text.
- Do NOT output any reasoning or thoughts. Do NOT use <think> tags. Output ONLY the translated Markdown.